...
import com.springproject.managio.model.Token;
...
public class AuthenticationService {
  ...
  public AuthenticationResource register(RegisterDTO request) {
  ...
  public AuthenticationResource authenticate(AuthenticationDTO request) {
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      ...
      if (jwtService.isTokenValid(refreshToken, user)) {
        ...
        var authResponse = AuthenticationResource.builder()
